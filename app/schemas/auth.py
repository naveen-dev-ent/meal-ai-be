"""
Fixed authentication schemas with Pydantic v2 compatibility
"""
...
class UserSignUp(BaseModel):
    ...
    cuisines: List[str] = Field(..., min_length=2, max_length=6)  # mandatory + optional
...
class UserSignInJSON(BaseModel):
    """JSON user signin schema"""
...
class ProfileCompletion(BaseModel):
    ...
    # Required Health and Diet
    diet: DietEnum
    preferred_meats: Optional[List[str]] = None  # for non-vegetarians
    
    # Required Preferences
    cuisines: List[str] = Field(..., min_length=2, max_length=6)
...
class UserUpdate(BaseModel):
    ...
    # Preferences
    meal_styles: Optional[List[str]] = None
    cuisines: Optional[List[str]] = Field(None, min_length=2, max_length=6)
    dining_style: Optional[DiningStyleEnum] = None
